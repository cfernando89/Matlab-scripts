...
%//                     X 6 - Trigger_time (21=sin�nimos; 22=n-sin�nimos; 23=pseudopalavra)
%//                     

%// Trigger code
%// 12 = (200,0,0) - Sin�nimo
%// 14 = (232,0,0) - N�o Sin�nimo
%// 16 = (0,24,0) - Pseudopalavra
%// 22 = (104,24,0) - Sin�nimo (Tempo)
%// 24 = (136,24,0) - N�o Sin�nimo (Tempo)
...
%// cd 'F:\MATLAB_task\Triggado' %Alterar para computador
...
%// load('F:\MATLAB_task\Triggado\Verbos_final.mat');
...
if ~isempty(SubId)
    ...
    try
        ...
        %// Consultar a dura��o do frame da tela (Inter-Flip Interval)
  ...
  %%//     
    ...
    %Instructions part 2
        %// Draw the lines on the screen     
            ...
            [~, ~, bbox] = DrawFormattedText(w, Instructions1, 'center', 'center', Gray);
    ...
    %Instructions part 2 
            ...
            Instructions2 = ['Para responder, utilize as duas \n'...
                        ...
                        '\n'];
            Screen('FillRect', w, [0, 0, 0]);
            [~, ~, bbox] = DrawFormattedText(w, Instructions2, 'center', 'center', Gray);
            Screen('FrameRect', w, 0, bbox);
            Screen('Flip', w);
    ...
    %Instructions part 3
        %// Draw the lines on the screen     
            ...
            Instructions3 = ['Durante o experimento, havera intervalos, para \n'...
                        ...
                        '\n'];
            Screen('FillRect', w, [0, 0, 0]);
            [~, ~, bbox] = DrawFormattedText(w, Instructions3, 'center', 'center', Gray);
            Screen('FrameRect', w, 0, bbox);
            Screen('Flip', w);
...
%//                   Screen('FillRect',windowPtr [,color] [,rect] )
                    ...
                    %// Show the screen
%//                     if stim_trialSeq(iii) == 2 %time expectancy brake %%Define time of Mask until Target is shown (600 or 1200ms).
...
for Pwl = 1:6 %Loop apresenta��o das palavras
